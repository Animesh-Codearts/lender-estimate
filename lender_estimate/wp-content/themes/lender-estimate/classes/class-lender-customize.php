...
if ( ! class_exists( 'lender_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 */
	class lender_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'lender' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'lender' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'lender' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'lender' ),
						'full'    => esc_html__( 'Full text', 'lender' ),
					),
				)
			);
			...
			include_once get_theme_file_path( 'classes/class-lender-customize-color-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

			// Register the custom control.
			$wp_customize->register_control_type( 'lender_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new lender_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'lender' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
